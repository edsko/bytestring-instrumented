...
-- |
-- Module      : Instrumented.Data.ByteString.Lazy
...
-- better complexity than their "Instrumented.Data.ByteString" equivalents, due to
...
import qualified Instrumented.Data.ByteString        as P  (ByteString) -- type name only
import qualified Instrumented.Data.ByteString        as S  -- S for strict (hmm...)
...
import Instrumented.Data.ByteString.Lazy.Internal
...
-- see Note [Avoid NonEmpty combinators] in Instrumented.Data.ByteString
...
moduleError fun msg = error ("Instrumented.Data.ByteString.Lazy." ++ fun ++ ':':' ':msg)
...
--
-- > import qualified Instrumented.Data.ByteString.Lazy as BL
-- > main = do
...
-- for the strict "Instrumented.Data.ByteString" API. However, the above 'LazyByteString' variant
-- of the program fails with @openBinaryFile: resource busy (file is locked)@.
--
-- The reason for this is that "Instrumented.Data.ByteString.Lazy" is specifically designed
...
-- consider using strict 'Instrumented.Data.ByteString.readFile',
