...
-- |
-- Module      : Instrumented.Data.ByteString.Short.Internal
...
import qualified Instrumented.Data.ByteString.Internal.Type as BS
...
isValidUtf8 sbs@(unSBS -> ba#) = accursedUnutterablePerformIO $ do
  ...
  -- Instrumented.Data.ByteString.isValidUtf8
...
moduleErrorMsg fun msg = "Instrumented.Data.ByteString.Short." ++ fun ++ ':':' ':msg
