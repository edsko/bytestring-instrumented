...
-- |
-- Module      : Instrumented.Data.ByteString.Internal.Type
...
import GHC.Exts                 (Addr#, minusAddr#, ByteArray#)
...
-- "Instrumented.Data.ByteString.Char8" it can be interpreted as containing 8-bit
-- characters.
--
...
-- is the case with @\"string\"\#@ literals in GHC). Use 'Instrumented.Data.ByteString.Unsafe.unsafePackAddressLen'
...
-- 'Instrumented.Data.ByteString.Unsafe.unsafePackCStringLen' or
-- 'Instrumented.Data.ByteString.Unsafe.unsafePackCStringFinalizer' instead.
--
...
overflowError fun = throw $ SizeOverflowException msg
  where msg = "Instrumented.Data.ByteString." ++ fun ++ ": size overflow"
