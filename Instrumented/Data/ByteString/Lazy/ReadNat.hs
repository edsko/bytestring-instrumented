...
-- This file is included by "Instrumented.Data.ByteString.ReadInt", after defining
...
module Instrumented.Data.ByteString.ReadNat
#else
module Instrumented.Data.ByteString.Lazy.ReadNat
#endif
    ( readInteger
    , readNatural
    ) where
