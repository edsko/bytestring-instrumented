...
-- This file is also included by "Instrumented.Data.ByteString.ReadInt", after defining
...
module Instrumented.Data.ByteString.ReadInt
#else
module Instrumented.Data.ByteString.Lazy.ReadInt
#endif
    ( readInt
    , readInt8
    , readInt16
...
import qualified Instrumented.Data.ByteString.Internal as BI
#ifdef BYTESTRING_STRICT
import Instrumented.Data.ByteString
#else
...
import Instrumented.Data.ByteString.Internal (pattern BS, plusForeignPtr)
import Data.Int
import Data.Word
