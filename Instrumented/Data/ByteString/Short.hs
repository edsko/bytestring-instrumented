...
-- |
-- Module      : Instrumented.Data.ByteString.Short
...
--
-- In typical use cases it can be imported alongside "Instrumented.Data.ByteString", e.g.
--
-- > import qualified Instrumented.Data.ByteString       as B
-- > import qualified Instrumented.Data.ByteString.Short as B
-- >          (ShortByteString, toShort, fromShort)
--
-- Other 'ShortByteString' operations clash with "Instrumented.Data.ByteString" or "Prelude"
-- functions however, so they should be imported @qualified@ with a different
-- alias e.g.
--
-- > import qualified Instrumented.Data.ByteString.Short as B.Short
--
module Instrumented.Data.ByteString.Short (
    ...
    --
    -- * t'Instrumented.Data.ByteString.ByteString' unshared: 8 words; 32 or 64 bytes.
    --
    -- * t'Instrumented.Data.ByteString.ByteString' shared substring: 4 words; 16 or 32 bytes.
    --
    -- * 'ShortByteString': 4 words; 16 or 32 bytes.
    --
    -- For the string data itself, both 'ShortByteString' and t'Instrumented.Data.ByteString.ByteString' use
    ...
    -- 'ShortByteString' or t'Instrumented.Data.ByteString.ByteString' is unpacked into another constructor.
    --
    -- For example:
    --
    ...
    -- ** Heap fragmentation
    -- | With GHC, the t'Instrumented.Data.ByteString.ByteString' representation uses /pinned/ memory,
...
import Instrumented.Data.ByteString.Short.Internal
import Prelude ()
