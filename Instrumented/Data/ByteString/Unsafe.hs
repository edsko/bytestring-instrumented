...
-- |
-- Module      : Instrumented.Data.ByteString.Unsafe
...
import Instrumented.Data.ByteString.Internal
...
-- 'Instrumented.Data.ByteString.useAsCString', which makes a copy of the original 'ByteString'.
--
...
-- doubt, use 'Instrumented.Data.ByteString.useAsCString'.
--
...
-- will break referential transparency. To avoid this, use
-- 'Instrumented.Data.ByteString.useAsCStringLen', which makes a copy of the original 'ByteString'.
--
-- If 'Instrumented.Data.ByteString.empty' is given, it will pass @('Foreign.Ptr.nullPtr', 0)@.
