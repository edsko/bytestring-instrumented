...
See "Instrumented.Data.ByteString.Builder.Prim" for further
...
Similarly, using /O(n)/ concatentations like '++' or the equivalent 'Instrumented.Data.ByteString.concat'
...
Apart from removing intermediate data-structures,
  ...
  parameters using the functions in "Instrumented.Data.ByteString.Builder.Extra" and
  their \"inner loops\" using the functions in
  "Instrumented.Data.ByteString.Builder.Prim".
-}


module Instrumented.Data.ByteString.Builder
    (
      -- * The Builder type
      Builder
      ...
      -- cases. See "Instrumented.Data.ByteString.Builder.Extra", for information
    ...
    , module Instrumented.Data.ByteString.Builder.ASCII
    , module Instrumented.Data.ByteString.Builder.RealFloat
...
import           Instrumented.Data.ByteString.Builder.ASCII
import           Instrumented.Data.ByteString.Builder.RealFloat
...
{- Not yet stable enough.
   See note on 'hPut' in Instrumented.Data.ByteString.Builder.Internal
-}
...
-- using 'Instrumented.Data.ByteString.Lazy.hPut' . 'toLazyByteString' with a file handle.
--
-- @since 0.11.2.0
