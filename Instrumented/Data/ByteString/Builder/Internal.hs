...
--
module Instrumented.Data.ByteString.Builder.Internal (
  -- * Buffer management
    Buffer(..)
  , BufferRange(..)
  , newBuffer
...
import qualified Instrumented.Data.ByteString.Short.Internal as Sh
          ...
          where
            ...
            fillBuffer buf
              | freeSpace buf < minFree =
                  error $ unlines
                    [ "Instrumented.Data.ByteString.Builder.Internal.hPut: internal error."
...
-- function 'Instrumented.Data.ByteString.Builder.toLazyByteString' is defined as follows.
--
-- @
...
--
-- In most cases, the parameters used by 'Instrumented.Data.ByteString.Builder.toLazyByteString' give good
-- performance. A sub-performing case of 'Instrumented.Data.ByteString.Builder.toLazyByteString' is executing short
