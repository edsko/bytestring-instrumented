...
-- The "Instrumented.Data.ByteString.Builder.Prim.Tests" module provides you with
-- utilities for testing your encodings thoroughly.
--
module Instrumented.Data.ByteString.Builder.Prim.Internal (
...
-- primitive.
--
-- > import Instrumented.Data.ByteString.Builder.Prim as P
...
--
-- @
--charASCIIDrop = 'condB' (< \'\\128\') ('liftFixedToBounded' 'Instrumented.Data.ByteString.Builder.Prim.char7') 'emptyB'
-- @
