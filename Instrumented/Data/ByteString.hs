...
-- |
-- Module      : Instrumented.Data.ByteString
...
-- is to use the builder monoid from "Instrumented.Data.ByteString.Builder".
--
...
module Instrumented.Data.ByteString (
        ...
        -- to also check the 'Instrumented.Data.ByteString.Short.ShortByteString' type.
...
import Instrumented.Data.ByteString.Internal.Type
import Instrumented.Data.ByteString.Lazy.Internal (fromStrict, toStrict)
import Instrumented.Data.ByteString.Unsafe
...
isValidUtf8 (BS ptr len) = accursedUnutterablePerformIO $ unsafeWithForeignPtr ptr $ \p -> do
  ...
  -- Instrumented.Data.ByteString.Short.Internal.isValidUtf8
  i <- if len < 1000000
...
{-# DEPRECATED getLine
     "Deprecated since @bytestring-0.12@. Use 'Instrumented.Data.ByteString.Char8.getLine' instead. (Functions that rely on ASCII encodings belong in \"Instrumented.Data.ByteString.Char8\")"
  #-}

-- | Read a line from a handle
hGetLine :: Handle -> IO ByteString
hGetLine h =
  wantReadableHandle_ "Instrumented.Data.ByteString.hGetLine" h $
...
{-# DEPRECATED hGetLine
     "Deprecated since @bytestring-0.12@. Use 'Instrumented.Data.ByteString.Char8.hGetLine' instead. (Functions that rely on ASCII encodings belong in \"Instrumented.Data.ByteString.Char8\")"
  #-}
...
moduleErrorMsg fun msg = "Instrumented.Data.ByteString." ++ fun ++ ':':' ':msg
